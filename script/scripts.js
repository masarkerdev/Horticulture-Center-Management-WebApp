...
//       .catch(() => {
//         if (attempt < 3) {
//           btn.textContent = `আবার চেষ্টা হচ্ছে (${attempt}/3)...`;
//           setTimeout(() => tryLogin(attempt + 1), 3000);
//         } else {
//           btn.textContent = "লগইন করুন";
//           btn.disabled = false;
//           er.textContent = "সংযোগ সমস্যা। পেজ Refresh করে আবার চেষ্টা করুন।";
//           er.style.display = "block";
//         }
//       });
//   };
...
//       </div>
//       <div class="sl">চারার ক্যাটেগরি</div>
//       <div class="sv">${toBnNum(d.seedling_types)}</div>
//       <div class="ss2">প্রকার নিবন্ধিত</div>
//     </div>
//     <div class="sc">
//       <div class="si" style="background: var(--t50)">
//         <i
//           class="ti ti-stack-2"
//           style="color: var(--t600); font-size: 18px"
//         ></i>
//       </div>
//       <div class="sl">মোট স্টক</div>
//       <div class="sv">${toBnNum(d.total_stock)}</div>
//       <div class="ss2">টি চারা/কলম</div>
//     </div>
//     <div class="sc">
//       <div class="si" style="background: var(--a50)">
//         <i class="ti ti-sun" style="color: var(--a400); font-size: 18px"></i>
//       </div>
//       <div class="sl">আজকের উৎপাদন</div>
//       <div class="sv">${toBnNum(d.today_production)}</div>
//     </div>
//     <div class="sc">
//       <div class="si" style="background: var(--c50)">
//         <i
//           class="ti ti-receipt"
//           style="color: var(--c400); font-size: 18px"
//         ></i>
//       </div>
//       <div class="sl">আজকের বিক্রয়</div>
//       <div class="sv">${toBnMoney(d.today_revenue)}</div>
//       <div class="ss2">${toBnNum(d.today_invoices)}টি চালান</div>
//     </div>
//     <div class="sc">
//       <div class="si" style="background: var(--b50)">
//         <i class="ti ti-coin" style="color: var(--b600); font-size: 18px"></i>
//       </div>
//       <div class="sl">মাসিক আয়</div>
//       <div class="sv">${toBnMoney(d.monthly_revenue)}</div>
//       <div class="ss2">এই মাসে</div>
//     </div>`;
...
//           .map(
//             (x) =>
//               `<tr><td>${fmtDMY(x.damage_date)}</td><td>${x.name_bn || "-"}</td><td>${x.batch_code || "-"}</td><td><strong>${x.quantity}</strong></td><td><span class="b br">${DN[x.reason] || x.reason}</span></td><td>${x.remarks || "-"}</td><td>${x.reporter || "-"}</td></tr>`,
//           )
//           .join("")
