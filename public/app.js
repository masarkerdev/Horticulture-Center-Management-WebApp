    ...
    <div id="invoicePrint" style="font-family:'Noto Sans Bengali',Arial,sans-serif;color:#222;background:#fff;padding:10px">
      ...
      <div style="border-bottom:3px solid #3B6D11;padding-bottom:14px;margin-bottom:16px">
        <div style="display:flex;align-items:center;justify-content:space-between">
          <img src="./images/govt logo.png" style="width:60px;height:60px;object-fit:contain" alt="govt logo">
          <div style="text-align:center;flex:1;padding:0 12px">
            ...
            <div style="font-size:11px;color:#888">কৃষি সম্প্রসারণ অধিদপ্তর|বাংলাদেশ কৃষি মন্ত্রণালয়</div>
          </div>
          <img src="./images/favicon.jpg" style="width:60px;height:60px;object-fit:contain;border-radius:50%" alt="center logo">
        </div>
      </div>
      <!-- Invoice Info -->
