    ...
    try {
        ...
        const result = await db.query(`
            SELECT
                ...
                (SELECT COALESCE(SUM(produced_quantity), 0) FROM production_batches WHERE production_type='seed') AS prod_seed,
                (SELECT COALESCE(SUM(produced_quantity), 0) FROM production_batches WHERE production_type!='seed') AS prod_asex,
        ...
        res.json({
            ...
            data: {
                ...
                prod_seed:        parseInt(d.prod_seed) || 0,
                prod_asex:        parseInt(d.prod_asex) || 0,
